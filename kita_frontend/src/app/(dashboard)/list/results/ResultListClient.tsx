...
export default function ResultListClient({
  ...
  const columns = [
    ...
    { header: dict.results.columns.student, accessor: "student" },
    {
      header: dict.results.columns.score,
      accessor: "score",
      className: "hidden md:table-cell",
    },
    {
      header: dict.results.columns.teacher,
      accessor: "teacher",
      className: "hidden md:table-cell",
    },
    {
      header: dict.results.columns.class,
      accessor: "class",
      className: "hidden md:table-cell",
    },
    {
      header: dict.results.columns.date,
      accessor: "date",
      className: "hidden md:table-cell",
    },
